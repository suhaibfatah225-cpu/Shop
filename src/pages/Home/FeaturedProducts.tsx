import { Heart, RefreshCcw, Eye, Plus, Star, StarHalf } from 'lucide-react';
  ...
  return (
    <div className="container mx-auto px-4 py-12">
      <div className="flex items-center gap-3 mb-8">
        ...
        <h2 className="text-2xl font-bold text-gray-900">Featured <span className="text-green-600">Products</span></h2>
      </div>
